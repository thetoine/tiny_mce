...
== Version 0.1.9.2
* Upgraded TinyMCE to 3.4.2 (Francesc Pla)
* Added spanish to available languages (Francesc Pla)
* Support for Rails 3.1, js placed on "app/assets/javascripts/tiny_mce", remember to exclude them from aplication.js loading (Francesc Pla)
