...
Gem::Specification.new do |s|
  s.name = "tiny_mce"
  s.version = "0.1.9.2"
  s.authors = ["Blake Watters", "Kieran Pilkington", "Sergio Cambra", "Alexander Semyonov", "Marian Theisen", "Walter McGinnis", "Frederico Macedo de Assunção", "Josh Proehl", "Sasha Gerrand", "Francesc Pla"]
